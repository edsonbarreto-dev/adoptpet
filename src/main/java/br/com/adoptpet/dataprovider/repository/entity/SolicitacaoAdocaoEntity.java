...
public class SolicitacaoAdocaoEntity {
    ...
    public SolicitacaoAdocaoEntity(PetEntity pet, PessoaEntity solicitante, PessoaEntity funcionario, LocalDate dataSolicitacao) {
        this.pet = pet;
    ...
    public SolicitacaoAdocaoEntity(PetEntity pet, PessoaEntity solicitante, LocalDate dataSolicitacao) {
        this.pet = pet;
        this.solicitante = solicitante;
         this.dataSolicitacao = dataSolicitacao;
    }
